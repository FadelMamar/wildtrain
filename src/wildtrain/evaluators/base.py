...
import pandas as pd
from supervision.metrics import MeanAveragePrecision, MeanAverageRecall, Precision, Recall, F1Score
...
class BaseEvaluator(ABC):
    ...
    def __init__(self, config: Union[Dict[str, Any], str]):
        ...
        self.metrics = dict(
            mAP=MeanAveragePrecision('boxes',class_agnostic=self.config.metrics.class_agnostic, class_mapping=None),
